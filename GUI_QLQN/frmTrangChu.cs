...
namespace GUI_QLQN
{
    public partial class FrmTrangChu : Form
    {
        ...
        {
            LoadChildForm(new FrmQuanLyNhanVien(), "QUẢN LÝ NHÂN VIÊN", Properties.Resources.icons8_employee_64);
        ...
        {
            LoadChildForm(new FrmQuanLyChucVu(), "QUẢN LÝ CHỨC VỤ", Properties.Resources.icons8_tasklist_96);
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
        ...
        private void FrmQLLM_Click(object sender, EventArgs e)
        {
            LoadChildForm(new FrmQuanLyLoaiMay(), "QUẢN LÝ LOẠI MÁY", Properties.Resources.LoaiMay2);
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
        ...
        {
            LoadChildForm(new frmThongKe(), "THỐNG KÊ", Properties.Resources.icons8_statistic_64);
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
        ...
        {
            LoadChildForm(new FrmLoaiKH(), "QUẢN LÝ LOẠI KHÁCH HÀNG", Properties.Resources.icons8_user_100);
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
        ...
        private void btnLCLV_Click(object sender, EventArgs e)
        {
            LoadChildForm(new FrmQuanLyLoaiCLV(), "QUẢN LÝ LOẠI CA LÀM VIỆC");
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
        ...
        {
            LoadChildForm(new FrmQuanLyHTTT(), "QUẢN LÝ HÌNH THỨC THANH TOÁN", Properties.Resources.icons8_card_96);
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
        ...
        {
            LoadChildForm(new FrmLoaiDichVu(), "QUẢN LÝ LOẠI DỊCH VỤ", Properties.Resources.icons8_list_50);
            lblTitle2.Left = (panelTitle.Width - lblTitle2.Width) / 2;
            lblTitle2.Top = (panelTitle.Height - lblTitle2.Height) / 2;
        }
